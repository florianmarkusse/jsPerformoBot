            ...
            if (c) {
                ...
                for (f = 0; (h = t[f]) != null; f++)
                    if (!p.nodeName(h, 'script') || !q(h))
                        c.appendChild(h), typeof h.getElementsByTagName != 'undefined' && (r = p.grep(p.merge([], h.getElementsByTagName('script')), q), t.splice.apply(t, [
                            f + 1,
                            0
                        ].concat(r)), f += r.length);
            }
    ...
    p.fn.extend({
        ...
        p.cssHooks[a + b] = {
            expand: function (c) {
                ...
                for (d = 0; d < 4; d++)
                    f[a + bV[d] + b] = undefined || e[d - 2] || e[0];
                return f;
            }
